	...
	<div class="container">
		...
		<div class="row panel">
			<div class="col-8 mx-auto pt-5">
				<div class="row">
					<div class="col-12">
						<a href="index.html" class="text fs-20" style="color: rgba(255, 255, 255, 0.6);">Главная / </a><a href="" class="text-light text fs-20">Форма заявки</a>
					</div>
					...
					<div class="col-8">
						<p class="text fs-20" style="color: rgba(255, 255, 255, 0.6);">Отправьте нам запрос, указав краткую информацию (тип сайта, примерный бюджет, контактные данные). Мы проанализируем заявку и свяжемся с вами, как только подберем оптимальные решения для вашей ситуации.</p>
					</div>
				</div>
			</div>
